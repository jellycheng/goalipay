...
func main() {
	...
	// 公共参数，设置通知地址和跳转地址
	commonMap := make(gosupport.BodyMap)
...
支付成功后在跳转地址中追加参数如下：
    ?charset=utf-8&out_trade_no=商户订单号&method=alipay.trade.page.pay.return&total_amount=支付金额&sign=签名&trade_no=支付宝订单号&auth_app_id=应用ID&version=1.0&app_id=应用ID&sign_type=RSA2&seller_id=购买者&timestamp=时间
...
支付成功h5页面跳转地址追加参数如下：
    ?charset=utf-8&out_trade_no=商户订单号&method=alipay.trade.wap.pay.return&total_amount=金额&sign=签名&trade_no=支付宝单号&auth_app_id=应用ID&version=1.0&app_id=应用ID&sign_type=RSA2&seller_id=购买者ID&timestamp=时间
